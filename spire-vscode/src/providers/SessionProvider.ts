/**
 * SessionProvider — analyzes user prompts and decides which graph-memory
 ...
 *
 * USAGE:
 *   const provider = new SessionProvider({ userId: 'user-123' });
...
export class SessionProvider implements ToolCallProvider {
